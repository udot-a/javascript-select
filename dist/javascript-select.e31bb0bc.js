...
function getTemplate() {
  ...
  var list = data.map(function (_ref) {
    var id = _ref.id,
        value = _ref.value;
...
var Select = /*#__PURE__*/function () {
  function Select(selector, options) {
    ...
    _defineProperty(this, "select", function (id) {
      if (!id) {
        return;
      }

      _this.selectedId = id;
      _this.$value.textContent = _this.current.value;

      _this.$el.querySelectorAll("[data-type=\"item\"]").forEach(function (item) {
        return item.classList.remove("selected");
      });

      _this.$el.querySelector("[data-id=\"".concat(id, "\"]")).classList.add("selected");

      _this.options.onSelect && _this.options.onSelect(_this.current);
...
},{"./bundle-url":"C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/styles.scss":[function(require,module,exports) {
...
window.s = select;
},{"./select/select":"select/select.js","./select/styles.scss":"select/styles.scss"}],"C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
